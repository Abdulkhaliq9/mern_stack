  ...
  return (
    ...
    <div className="row no-gutters">
      ...
      <div className="col-xxl-8 col-md-12">
          ...
          <div className="carousel-inner">
              ...
              <img  src={Slider1} className="d-block w-100 " alt="..." />
               <div className="slider-content">
                ...
                <div className="slider-description">
                  Spring into incredible deals on a selection of TVs,
                  Smart screens, and so much more.
            ...
            <div className="carousel-item">
              ...
              <div className="slider-content">
                ...
                <div className="slider-description">
                  Dining, living, and desk areas serve their purposes in
                  total harmony of style.
                </div>
                <div className="slider-shopnow">
                  <button className="btn">Shop Now</button>
                </div>
        ...
        <a className="control-prev" type="button" data-bs-target="#carouselExampleAutoplaying" data-bs-slide="prev">
            <ChevronLeft/>
          </a>
        </div>
        <div className="car-next  start-100  ">
        <a className="control-next" type="button" data-bs-target="#carouselExampleAutoplaying" data-bs-slide="next">
           <ChevronRight/>
          </a>
        </div>
        </div>
...
{/* <img src={NewArrival} class=" img-fluid" alt="Image 3" /> */}
              <div className="arrival-content">
                ...
                <div className="arrival-description ">A collection of premium  <br />
                  organic pieces.
                </div>
...
{/* <img src={Featured} className="img-fluid" alt="Image 4" /> */}
              ...
              <div className="featured-content">
                ...
                <div className="featured-description">A collection of premium  <br />
                  organic pieces.
                </div>
