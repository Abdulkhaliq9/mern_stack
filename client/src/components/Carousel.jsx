...
export default function Carousel() {
  ...
  return (
      ...
      <div className="relative w-full col-span-8  h-[450px]  border-gray-light bg-[rgba(242, 245, 250, 0.6)] rounded-2xl shadow-[0_4px_30px_rgba(0,0,0,0.1)] backdrop-blur-[6.7px] border-[3px] ">
        {/* Slides */}
