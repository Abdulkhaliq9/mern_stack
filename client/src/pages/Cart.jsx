  ...
  return (
    <UserLayout>
      <div className="row mt-5">
        <div className="col-lg-8 col-md-12 my-sm-3 ">
          <div className="cart_products">
            <div className="d-flex justify-content-between align-items-center">
              <h2>Cart</h2>

              <button className="btn border-0 text-danger fw-bold">
                <span className="pe-2">
                  <X />
                </span>
                Clear All
            ...
            <div className="cart_heading">
              <div className="mt-3 d-flex  justify-content-between align-content-center px-4 ">
            ...
            <div className="cart_items d-flex align-items-center justify-content-between  my-3">
              ...
              <div className="cart_item_count d-flex align-items-center">
                <div className="dec_btn">
                  <button className="btn border-0 " onClick={handleDecrement}>
                    <Minus />
                  </button>
                </div>
                {quantity}
                <div className="inc_btn">
                  <button className="btn border-0 " onClick={handleIncrement}>
                    {" "}
                    <Plus />{" "}
                  </button>
                </div>
